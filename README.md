# DDR_CONTROLLER
basic SystemVerilog DDR memory controller that enables read and write data transfer between an APB interface and a DDR memory operating in different clock domains.
module ddr_controller (
    ...
    always_ff @(posedge ddr_clk) begin
		...
		$display("ME INSIDE DRAM dram=%h time=%d", dram_rdata , $time);
